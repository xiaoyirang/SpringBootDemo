...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <c:if test="${user != null }">
    <form method="post" class="form-x" action="/userrepair/addUserrepair">    
		 ...
		 <div class="form-group">
		    ...
		    <div class="field">
		        <input type="text" class="input w50" value="${user.phone }" name="phone" />
		        <div class="tips"></div>
		    </div>
		 </div>
		 <div class="form-group">
		    ...
		    <div class="field">
		        <input type="text" class="input w50" value="" name="bookTime" />
		        <div class="tips"></div>
		    </div>
		 </div>
		 <div class="form-group">
